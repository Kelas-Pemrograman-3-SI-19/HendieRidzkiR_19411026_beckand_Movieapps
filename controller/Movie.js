...
exports.editMovie = (data, id, changeImage) =>
  new Promise(async(resolve, reject) => {
    movieModel.updateOne({
      ...
      .then(() => {
        ...
        resolve(requestResponse.sukses('Berhasil Edit Daftar Movie'))
      }).catch(() => reject(requestResponse.serverError))
  })
    ...
    new Promise((resolve, reject) => {
      movieModel.findOne({
        ...
        movieModel.deleteOne({
          ...
          resolve(requestResponse.sukses('Berhasil Hapus List movie'))
        }).catch(() => reject(requestResponse.serverError))
      })
    })